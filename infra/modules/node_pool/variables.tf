...
variable "eviction_policy" {
  description = "(Optional) The Eviction Policy for Spot instances. Possible values are Deallocate and Delete. Required when priority is set to Spot."
  type        = string
  default     = "Delete"
}

variable "spot_max_price" {
  description = "(Optional) The maximum price in USD you're willing to pay per VM. Use -1 for the on-demand price. Required when priority is set to Spot."
  type        = number
  default     = -1
}
